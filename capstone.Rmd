...
This model produced 72.9% accuracy rate.
```{r warning=FALSE}
...
### Construct Model
```{r warning=FALSE}
selected_variables <- c("y", "start_speed", "sz_bot", "vy0", "break_y", "trf_num_pitches", "trf_num_FA");
...
Model 3b has the highest accuracry rate.  
```{r warning=FALSE}
pred <- predict(mod_3b, pitches_dl_predict, type='response')*100;
